---
name: ui-ux-pro-max
description: Guide UI/UX design for web and mobile apps with styles, palettes, typography, accessibility, charts, and stack-specific rules.
---
...
- Run through Quick Reference **Section 1-Section 3** (CRITICAL + HIGH) as a final review

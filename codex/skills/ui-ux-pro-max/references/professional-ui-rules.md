...
Detailed professional UI rules moved out of `SKILL.md` for progressive disclosure.

## Contents

- [Common Rules for Professional UI](#common-rules-for-professional-ui)
- [Icons And Visual Elements](#icons--visual-elements)
- [Interaction](#interaction-app)
- [Light/Dark Mode Contrast](#lightdark-mode-contrast)
- [Layout And Spacing](#layout--spacing)

...
foreach ($path in @(
    ...
    "local-docs\experiments\agent-signal-and-measurement.md",
    ...
    "scripts\test-compaction-accounting.py",
    "scripts\test-prompt-inventory.py",
    "scripts\test-session-trace.py",

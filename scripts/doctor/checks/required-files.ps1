...
foreach ($path in @(
    ...
    "scripts\doctor\checks\generated-artifacts.ps1",
    "scripts\doctor\checks\hooks.ps1",
    "scripts\doctor\checks\manifest-boundaries.ps1",
    "scripts\doctor\checks\policy-contracts.ps1",
    "scripts\doctor\checks\retired-plugins.ps1",
    "scripts\doctor\checks\retired-skills.ps1",
    ...
    "scripts\doctor\checks\source-of-truth.ps1",
